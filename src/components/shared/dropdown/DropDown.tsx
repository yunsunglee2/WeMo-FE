    ...
    <div className={`relative inline-block ${className}`}>
      <Listbox value={selectedOption} onChange={onSelect}>
        {customTrigger ? (
          ...
          <Listbox.Button className="inline-flex items-center justify-between rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-black shadow-md focus:ring-2 focus:ring-blue-500">
